...
describe Ability, :type => :model do
  ...
  let (:file) do
    GenericFile.new.skip_fedora.tap do |gf|
  ...
  let (:collection) do
    Collection.new( title: "test collection").skip_fedora.tap do |c|
  ...
  let (:personal_collection) do
    Collection.new( title: "personal collection").skip_fedora.tap do |c|
      c.apply_depositor_metadata(user)
  ...
  let (:admin_collection) do
    Collection.new( title: "admin collection").skip_fedora.tap do |c|
      c.apply_depositor_metadata(user)
      c.is_official = true
      c.is_admin_set = true
